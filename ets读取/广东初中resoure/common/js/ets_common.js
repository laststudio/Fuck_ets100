        ...
        $(arr).each(function(index, item) {
            ...
            if ($('#' + number).hasClass('question1')) {
                ...
                if (isCorrect) {
                    ...
                    $("#" + number).find(".question2_title").css("color", "#43cb75");
                }else {
                    $('#' + number).find('.q_score_con').parent().removeClass('green').addClass('red');
                    $("#" + number).find(".question2_title").css("color", "#e65151");
                }
